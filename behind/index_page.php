...
class Page{
	...
	function show($show_num = 3){
		...
		if($start != 1){
			echo '<a href="behind_index.php?page=1'.$url_get.'"><li>1</li></a>';
			echo '<a><li class="nohref">...</li></a>';
		}
		for($i = $start; $i <= $end ; $i++){
			if($i == $this->curr_page){
				echo "<a href=behind_index.php?page=".$i.$url_get."><li class='curr'>".$i."</li></a>";
			}else{
				echo "<a href=behind_index.php?page=".$i.$url_get."><li>".$i."</li></a>";
			}
		}
		if($end != $this->page_all){
			echo '<a><li class="nohref">...</li></a>';
			echo '<a href="behind_index.php?page='.$this->page_all.$url_get.'"><li>'.$this->page_all.'</li></a>';
		}
		echo '</ul>';
	}
}
